...
class Notebook:
    ...
    def create_tabs(self):
        ...
        self.tab1 = Guia1(self.notebook, self.notify)
        self.tab2 = Guia2(self.notebook, self.notify)
...
def main():
    ...
    event_handler.attach_observer(controller)

    app = GUI_Manager(root, event_handler.notify)
    root.mainloop()
